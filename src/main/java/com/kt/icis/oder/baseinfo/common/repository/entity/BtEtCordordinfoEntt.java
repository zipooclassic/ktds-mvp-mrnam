...
import com.kt.icis.oder.baseinfo.common.repository.dto.BtEtCordordinfoDto;
...
public class BtEtCordordinfoEntt implements Persistable<String> {
    ...
    public static BtEtCordordinfoEntt of(BtEtCordordinfoDto dto) {
        return BtEtCordordinfoEntt.builder()
                .ordNo(dto.getOrdNo())
