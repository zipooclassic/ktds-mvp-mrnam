...
import com.kt.icis.oder.baseinfo.common.repository.dto.BtEiCordordinfoDto;
...
public class BtEiCordordinfoEntt implements Persistable<String> {
    ...
    // description = "오더상태코드", nullable = true, maxLength = 2
    ...
    // description = "구성완료예정일자", nullable = true, maxLength = 8
    ...
    // description = "설치주소내용", nullable = true, maxLength = 100
    @Column("ADDR_TEXT")
    ...
    // description = "접수일자", nullable = true, maxLength = 8
    @Column("RCV_DATE")
    ...
    // description = "완료여부", nullable = true, maxLength = 1
    ...
    // description = "이행일자", example = "YYYYMMDDHHMISS", nullable = true
    @Column("MIG_DATE")
    @JsonFormat(shape = JsonFormat.Shape.STRING, pattern = "yyyy-MM-dd HH:mm:ss", timezone = "Asia/Seoul")
    ...
    // description = "번호이동구분코드", nullable = true, maxLength = 1
    @Column("NP_KIND")
    ...
    // description = "일구분코드", nullable = true, maxLength = 2
    @Column("DAY_DIV")
    ...
    // description = "INSTL_TEL_NO", nullable = true, maxLength = 20
    @Column("INSTL_TEL_NO")
    ...
    public static BtEiCordordinfoEntt of(BtEiCordordinfoDto dto) {
        return BtEiCordordinfoEntt.builder()
                .ordNo(dto.getOrdNo())
                ...
                .ordTypeCd1(dto.getOrdTypeCd1())
                .ordTypeCd2(dto.getOrdTypeCd2())
                .saId(dto.getSaId())
