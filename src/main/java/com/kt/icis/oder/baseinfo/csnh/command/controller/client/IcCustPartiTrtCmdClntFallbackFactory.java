...
@Component
public class IcCustPartiTrtCmdClntFallbackFactory implements FallbackFactory<IcCustPartiTrtCmdClnt>{
	@Override
	public IcCustPartiTrtCmdClnt create(Throwable cause) {
		return new IcCustPartiTrtCmdClnt() {
