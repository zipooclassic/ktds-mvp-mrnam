...
import com.kt.icis.oder.baseinfo.common.repository.dto.BtInCordordinfoDto;
...
public class BtInCordordinfoEntt implements Persistable<String> {
    ...
    public static BtInCordordinfoEntt of(BtInCordordinfoDto dto) {
        return BtInCordordinfoEntt.builder()
                .ordNo(dto.getOrdNo())
