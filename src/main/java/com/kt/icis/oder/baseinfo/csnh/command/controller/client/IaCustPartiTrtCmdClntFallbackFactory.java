...
@Component
public class IaCustPartiTrtCmdClntFallbackFactory implements FallbackFactory<IaCustPartiTrtCmdClnt>{
	@Override
	public IaCustPartiTrtCmdClnt create(Throwable cause) {
		return new IaCustPartiTrtCmdClnt() {
