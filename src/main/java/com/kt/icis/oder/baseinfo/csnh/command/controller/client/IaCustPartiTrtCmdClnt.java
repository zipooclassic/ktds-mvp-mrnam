...
@FeignClient(name="IA.IaCustPartiTrtCmdClnt", url = "${api.inetaplca.url}", fallbackFactory=IaCustPartiTrtCmdClntFallbackFactory.class)
public interface IaCustPartiTrtCmdClnt {
