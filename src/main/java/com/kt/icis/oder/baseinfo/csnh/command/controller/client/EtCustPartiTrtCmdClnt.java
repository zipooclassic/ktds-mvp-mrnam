...
@FeignClient(name="ET.EtCustPartiTrtCmdClnt", url = "${api.etcterr.url}", fallbackFactory=EtCustPartiTrtCmdClntFallbackFactory.class)
public interface EtCustPartiTrtCmdClnt {
