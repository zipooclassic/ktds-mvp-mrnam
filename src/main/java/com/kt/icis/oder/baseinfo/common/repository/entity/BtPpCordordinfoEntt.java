...
import com.kt.icis.oder.baseinfo.common.repository.dto.BtPpCordordinfoDto;
...
public class BtPpCordordinfoEntt implements Persistable<String> {
    ...
    public static BtPpCordordinfoEntt of(BtPpCordordinfoDto dto) {
        return BtPpCordordinfoEntt.builder()
                .ordNo(dto.getOrdNo())
