...
public class BtPpCordordinfoDto implements Serializable {
	private static final long serialVersionUID = 1672049536402504089L;
	...
	@Schema(description = "사용자오더유형코드", nullable = true, maxLength = 2)
    private String userOrdTypeCd;
    
	@Schema(description = "오더유형코드", nullable = true, maxLength = 2)
	...
	@Schema(description = "서비스계약아이디", nullable = true, maxLength = 11)
    private String saId;
	...
	@Schema(description = "오더상태코드", nullable = true, maxLength = 2)
	...
	@Schema(description = "구성완료예정일자", nullable = true, maxLength = 8)
	...
	@Schema(description = "연락이메일", nullable = true, maxLength = 50)
	...
	@Schema(description = "설치주소내용", nullable = true, maxLength = 100)
	...
	@Schema(description = "접수일자", nullable = true, maxLength = 8)
	...
	@Schema(description = "완료여부", nullable = true, maxLength = 1)
	...
	@Schema(description = "이행일자", nullable = true, maxLength = 8)
	...
	@Schema(description = "번호이동구분코드", nullable = true, maxLength = 1)
	...
	@Schema(description = "일구분코드", nullable = true, maxLength = 2)
	...
	@Schema(description = "INSTL_TEL_NO", nullable = true, maxLength = 20)
