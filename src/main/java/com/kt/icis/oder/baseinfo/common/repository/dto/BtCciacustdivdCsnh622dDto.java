...
@NoArgsConstructor
@Schema(description = "")
public class BtCciacustdivdCsnh622dDto implements Serializable {

    /**
     *
     */
    private static final long serialVersionUID = 6455659682191823434L;
    ...
    @Schema(description = "B.P_NODE_ID in Ccpiprodhier", nullable = true, maxLength = 10)
    private String checkOldCustId;
    @Schema(description = "C.CUST_ID in ccstbasicinfo", nullable = true, maxLength = 10)
    private String checkNewCustId;
