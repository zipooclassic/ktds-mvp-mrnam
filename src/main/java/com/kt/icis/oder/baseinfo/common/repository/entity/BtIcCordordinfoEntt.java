...
import com.kt.icis.oder.baseinfo.common.repository.dto.BtIcCordordinfoDto;
...
public class BtIcCordordinfoEntt implements Persistable<String> {
    ...
    public static BtIcCordordinfoEntt of(BtIcCordordinfoDto dto) {
        return BtIcCordordinfoEntt.builder()
                .ordNo(dto.getOrdNo())
