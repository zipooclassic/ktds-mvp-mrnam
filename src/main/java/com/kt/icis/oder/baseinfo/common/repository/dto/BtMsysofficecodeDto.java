...
/**
 * 국사정보테이블(MDM) db table dto
 */
@AllArgsConstructor
@Builder
@Data
@NoArgsConstructor
@Schema(description = "국사정보테이블(MDM)")
public class BtMsysofficecodeDto implements Serializable {
	private static final long serialVersionUID = 1672049501816998883L;
	
	@Schema(description = "국사코드", nullable = false, maxLength = 6)
