...
@Component
public class EtCustPartiTrtCmdClntFallbackFactory implements FallbackFactory<EtCustPartiTrtCmdClnt>{
	@Override
	public EtCustPartiTrtCmdClnt create(Throwable cause) {
		return new EtCustPartiTrtCmdClnt() {
