...
import com.kt.icis.oder.baseinfo.csnh.command.controller.CustSpatnLnkCmdCntr;
 ...
 * @FileName: CustSpatnLnkCmdApi
 * @Class 설명 : 고객분리연동 데몬 API 작업
 * @작성일 : 2024. 08. 17.
...
@Tag(name = "고객분리연동데몬", description = "고객분리연동 데몬-CSNH622D")
public class CustSpatnLnkCmdApi {

	private final CustSpatnLnkCmdCntr  contrller;
	/**
	 * @Method Name : custSpatnLnk
	 * @Method 설명 : 고객분리연동 데몬
	 * @작성일 : 2024. 08. 17.
	 * @작성자 : 리그시스템 / 91347489 / 강동순
	 ...
	 */
	@Operation(summary = "고객분리연동데몬", description = "고객분리연동 데몬-CSNH622D")
    @PostMapping(path = "/cust/spatnlnk")
    public BiDaemonTmpUseOutCmdPyld custSpatnLnk(@RequestBody BiDaemonTmpUseInCmdPyld inPyld) {
		BiDaemonTmpUseOutCmdDto rtnDto = new BiDaemonTmpUseOutCmdDto();
		contrller.custSpatnLnk();
