...
@Component
public class InCustPartiTrtCmdClntFallbackFactory implements FallbackFactory<InCustPartiTrtCmdClnt>{
	@Override
	public InCustPartiTrtCmdClnt create(Throwable cause) {
		return new InCustPartiTrtCmdClnt() {
