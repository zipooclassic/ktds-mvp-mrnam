 ...
 */
@FeignClient(name="BT.csnh622d.ccmc241s", url = "http://icis-oder-sample.t-order.svc/sample", fallbackFactory=Csnh622dToCcmc241sCmdClntFallbackFactory.class)
public interface Csnh622dToCcmc241sCmdClnt {


    @PostMapping(value="/dummy/ccmc241")
    Csnh622dToCcmc241sOutCmdPyld callCcmc241s(@RequestHeader(Constant.FEIGN_HEADER) String feignHeader, @RequestBody Csnh622dToCcmc241sInCmdPyld inpyld);
