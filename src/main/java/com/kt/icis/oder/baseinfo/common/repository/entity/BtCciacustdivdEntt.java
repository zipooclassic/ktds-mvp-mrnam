...
import com.kt.icis.oder.baseinfo.common.repository.dto.BtCciacustdivdDto;
...
public class BtCciacustdivdEntt implements Persistable<String> {
    ...
    // description = "IF_HST_NO", nullable = true, maxLength = 22
    @Column("IF_HST_NO")
    ...
    // description = "분리후고객아이디", nullable = true, maxLength = 11
    @Column("NEW_CUST_ID")
    ...
    public static BtCciacustdivdEntt of(BtCciacustdivdDto dto) {
        return BtCciacustdivdEntt.builder()
                .saId(dto.getSaId())
