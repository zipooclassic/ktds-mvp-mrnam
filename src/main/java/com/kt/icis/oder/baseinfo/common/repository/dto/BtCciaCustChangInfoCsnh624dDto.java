...
@Data
@NoArgsConstructor
@Schema(description = "계약고객통합 연동")
public class BtCciaCustChangInfoCsnh624dDto implements Serializable {
	private static final long serialVersionUID = 1687585982863242902L;
	...
	@Schema(description = "고객식별번호유형코드", nullable = false, maxLength = 1)
    private String custNoType;
    
	@Schema(description = "고객식별번호", nullable = false, maxLength = 20)
    private String custNo;
    
	@Schema(description = "통합후고객아이디", nullable = true, maxLength = 11)
	...
	@Schema(description = "고객정보처리결과", nullable = true, maxLength = 1)
    private String custProcResult;
    
	@Schema(description = "고객처리일시", nullable = true, maxLength = 8)
    private Timestamp custProcDate;
    
	@Schema(description = "IPS처리일자", nullable = true, maxLength = 8)
    private Timestamp ipsProcDate;
    
	@Schema(description = "IPS처리결과", nullable = true, maxLength = 1)
    private String ipsProcResult;
    
	@Schema(description = "인터페이스이력번호", nullable = true, maxLength = 22)
