...
import com.kt.icis.oder.baseinfo.common.repository.dto.BTCciaCustDivdQryDto;
...
public class BtCciaCustDivdQryEntt implements Persistable<String> {
	...
	public static BtCciaCustDivdQryEntt of(BTCciaCustDivdQryDto dto) {
		return BtCciaCustDivdQryEntt.builder()
			.saId(dto.getSaId())
