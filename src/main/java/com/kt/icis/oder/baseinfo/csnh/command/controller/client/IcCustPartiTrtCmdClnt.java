...
@FeignClient(name="IC.IcCustPartiTrtCmdClnt", url = "${api.intelnet.url}", fallbackFactory=IcCustPartiTrtCmdClntFallbackFactory.class)
public interface IcCustPartiTrtCmdClnt {
