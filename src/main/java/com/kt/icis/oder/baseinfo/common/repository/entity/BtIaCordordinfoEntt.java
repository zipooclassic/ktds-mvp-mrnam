...
import com.kt.icis.oder.baseinfo.common.repository.dto.BtIaCordordinfoDto;
...
public class BtIaCordordinfoEntt implements Persistable<String> {
    ...
    public static BtIaCordordinfoEntt of(BtIaCordordinfoDto dto) {
        return BtIaCordordinfoEntt.builder()
                .ordNo(dto.getOrdNo())
