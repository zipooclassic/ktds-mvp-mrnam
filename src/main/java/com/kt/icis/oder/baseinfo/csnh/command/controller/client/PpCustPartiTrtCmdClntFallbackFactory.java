...
@Component
public class PpCustPartiTrtCmdClntFallbackFactory implements FallbackFactory<PpCustPartiTrtCmdClnt>{
	@Override
	public PpCustPartiTrtCmdClnt create(Throwable cause) {
		return new PpCustPartiTrtCmdClnt() {
