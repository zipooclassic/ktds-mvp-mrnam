...
@FeignClient(name="IN.InCustPartiTrtCmdClnt", url = "${api.infocomm.url}", fallbackFactory=InCustPartiTrtCmdClntFallbackFactory.class)
public interface InCustPartiTrtCmdClnt {
